...
export const Route = createFileRoute("/chat")({
  ...
  head: () =>
    seo({
      title: "AI Agent (Coming Soon) | Deadlock API",
      description:
        "An AI agent for Deadlock is on the way. Deep match analytics, interactive charts, and conversational insights about heroes, items, and strategies.",
      path: "/chat",
    }),
});
