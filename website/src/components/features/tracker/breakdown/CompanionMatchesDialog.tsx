...
import { MatchListItem } from "~/components/features/tracker/matches/MatchListItem";
...
function SharedMatches({
  ...
  return (
    <div className="flex min-h-0 flex-col gap-2 overflow-y-auto">
      <Card asChild tone="inset" size="flush" className="shrink-0">
        <nav
          ref={listRef}
    ...
    <Dialog open={open} onOpenChange={setOpen}>
      <DialogTrigger asChild>
        <Button
          variant="link"
          size="inline"
          className={cn("min-h-6 min-w-6", className)}
      ...
      <DialogContent className="flex flex-col">
        <DialogHeader className="shrink-0">
          <DialogTitle className="pe-5 break-words">
