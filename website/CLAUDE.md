...
tanstack-start
├── src
│   ├── router.tsx              # createRouter(): no default preload (links opt in with preload="intent"), scrollRestoration on
