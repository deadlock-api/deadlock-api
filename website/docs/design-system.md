...
| `ProgressBar`, `ProgressBarWithLabel`                                                                                                                                                                                                                                        | Comparative bars in tables; `thin` is the slim rounded bar beside a visible rate (positive unless `color` is given).                                                                                       | `variant`: bar, cell, thin. `ProgressBarSegment` children                                                                                                                                                                                                                 |
| `DivergingBar`                                                                                                                                                                                                                                                               | A signed value drawn from the centre of its track. `RateBar` is deprecated: `ProgressBar variant="thin"`.                                                                                                  | `value`, `scale`, `interval`                                                                                                                                                                                                                                              |
...
| `Input` (`size`: default, sm; `type="color"` is the swatch that opens the native picker), `Textarea`, `Select` (`size`: default, sm), `Slider` (`aria-label` or `thumbLabels` reach the thumbs), `Alert` (`variant`: default, primary, info, warning, positive, destructive) |                                                                                                                                                                                                            |                                                                                                                                                                                                                                                                           |
| `Switch`, `Label`, `Dialog`, `AlertDialog`, `Popover`, `Collapsible`, `Calendar`, `Avatar`, `Skeleton`, `Sonner`                                                                                                                                                             | shadcn primitives. Add more with `pnpm dlx shadcn@latest add <name>`, then `pnpm fmt`.                                                                                                                     |                                                                                                                                                                                                                                                                           |
...
| Controls of one chart or table                                         | `FilterBar variant="toolbar"` with `Field orientation="horizontal"`, `Segmented`, `Select size="sm"`, `FilterCell size="sm"` (and any selector built on it, such as `HeroSelector size="sm"`) |
| Generic filter controls                                                | `filter-bar/StringSelector`, `TriStateSelector`, `FilteredSelectPopover`, `NumberSelector`, `DateRangePicker`                                                                                 |
| Sortable column                                                        | `data-table/SortableHeader` (`align`, `size`: default, sm; `label` node; `sortLabel` names the button), or `SortButton` + `ariaSort()` when the cell holds more than the button               |
| Empty table body                                                       | `data-table/TableEmptyRow`                                                                                                                                                                    |
| Pagination                                                             | `data-table/PaginationControls` (`page`, `pageSize`, `size`: default, sm; children = the table's other controls, a `SearchInput` first)                                                       |
...
| Need                                         | Component                                                                                                                                                                 |
| -------------------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| The frame of every Recharts plot             | `ChartSurface` (`size`: xs, sm, md, default, lg, xl, fill; `variant`: card, flush, bare; `onResize`, `ref`, `style`). Never put surface classes on `ResponsiveContainer`. |
...
| Metric and interval controls                 | `TrendMetricField`, `TrendIntervalField`, `MetricSelect`                                                                                                                  |
