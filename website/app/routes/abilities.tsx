...
const AbilityOrderTree = lazy(
	() => import("~/components/abilities/AbilityOrderTree"),
);
...
export const meta: MetaFunction = () => {
	return createPageMeta({
		...
		description:
			"Ability upgrade paths and win rates for every Deadlock hero. Analyze optimal skill orders by rank.",
		path: "/abilities",
	});
};
