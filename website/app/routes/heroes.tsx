...
export const meta: MetaFunction = () => {
	return createPageMeta({
		...
		description:
			"View win rates, pick rates, matchups, and performance analytics for all Deadlock heroes.",
		path: "/heroes",
	});
};
		...
		<div className="space-y-6">
			<div className="text-center">
				...
				<p className="mt-1 text-sm text-muted-foreground">
					Detailed analytics and matchup data for Deadlock heroes
				</p>
				<p className="mx-auto mt-2 max-w-2xl text-sm leading-relaxed text-muted-foreground">
					Explore win rates, pick rates, and matchup data for every Deadlock
					hero. Filter by rank, patch, and game mode to find the strongest
					heroes in the current meta or analyze how hero performance changes
					over time.
				</p>
			</div>
						...
						<div className="flex flex-wrap justify-center gap-2 sm:flex-nowrap">
							<div className="flex flex-col gap-1.5">
								...
								<HeroStatSelector
									...
									onChange={(val) =>
										filters.setHeroStat(val as typeof filters.heroStat)
									}
								/>
							</div>
							<div className="flex flex-col gap-1.5">
								...
								<HeroTimeIntervalSelector
									...
									onChange={(val) =>
										filters.setHeroTimeInterval(
											val as typeof filters.heroTimeInterval,
										)
									}
								/>
							</div>
					...
					<div className="mt-4 flex flex-col gap-4">
						<div className="flex flex-wrap items-center justify-center gap-8 sm:flex-nowrap">
							<div className="flex items-center gap-2">
								<Label
									htmlFor={sameLaneFilterId1}
									className="text-sm font-semibold text-nowrap text-foreground"
								>
									Same Lane Filter
								</Label>
								<Checkbox
							...
							<div className="flex items-center gap-2">
								...
								<Checkbox
									...
									onCheckedChange={(i) =>
										filters.setSamePartyFilter(i === true)
									}
								/>
							</div>
						</div>
							...
							<div className="flex flex-col flex-wrap items-center gap-2 sm:flex-nowrap">
								<div className="flex items-center gap-2">
									...
									<Checkbox
										...
										checked={filters.sameLaneFilter}
										onCheckedChange={(i) =>
											filters.setSameLaneFilter(i === true)
										}
									/>
								</div>
								<div className="flex items-center gap-2">
									<Label
										htmlFor={samePartyFilterId2}
										className="text-sm font-semibold text-nowrap text-foreground"
									>
										Same Party Filter
									</Label>
