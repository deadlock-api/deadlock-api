...
const socialLinks = [
  {
    ...
    icon: (
      <svg className="w-5 h-5" fill="none" stroke="currentColor" strokeWidth={2} viewBox="0 0 180 180" aria-hidden>
        <path
          fill="currentColor"
        ...
        <div className="flex items-center justify-center gap-1">
          {socialLinks.map((link) => (
            <a
              ...
              target="_blank"
              rel="noopener noreferrer"
              className={cn("p-2 text-gray-500 rounded", link.hoverClass)}
              title={link.title}
