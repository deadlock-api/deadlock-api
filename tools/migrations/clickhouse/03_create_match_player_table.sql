...
(
    ...
    x_pos Array(UInt16) DEFAULT '[]' CODEC(Delta, ZSTD(3)),
    y_pos Array(UInt16) DEFAULT '[]' CODEC(Delta, ZSTD(3)),
    health Array(UInt8) DEFAULT '[]' CODEC(Delta, ZSTD(3)),
    combat_type Array(UInt8) DEFAULT '[]' CODEC(ZSTD(3)),
    move_type Array(UInt8) DEFAULT '[]' CODEC(ZSTD(3)),
