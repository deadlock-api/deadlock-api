              ...
              <div className="grid gap-6 text-pretty mx-auto w-fit">
                <div>
                  ...
                  <p className="ml-4 w-fit max-w-72">
                    Since December 2024, we've been using average rank (per-team) data directly from Valve of teams in
                    each match. Our system uses this to estimate the rank for every player.
                  </p>
                </div>
                <div>
                  <h4 className="font-bold text-lg">Initialization</h4>
                  <p className="ml-4 w-fit max-w-72">
                    Each player gets their first rank based on the average rank of their team in their first match where
                    Valve provided an average rank.
                  </p>
                </div>
