  ...
  return (
    <header className="flex items-center justify-end p-6 bg-sidebar text-header-foreground">
      <div className="flex items-center space-x-5">
        <a href={GITHUB_LINK} target="_blank" rel="noopener noreferrer" title="Visit our GitHub">
          <GithubIcon width={24} height={24} />
        </a>
        <a href={DISCORD_LINK} target="_blank" rel="noopener noreferrer" title="Join our Discord">
          <DiscordIcon width={24} height={24} />
        </a>
        <a href={STATUS_PAGE_LINK} target="_blank" rel="noopener noreferrer" title="Status">
          <StatusIcon width={24} height={24} />
        </a>
        <a href={PATREON_LINK} target="_blank" rel="noopener noreferrer" title="Support us on Patreon">
